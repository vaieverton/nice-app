...
var CategoriaController = /** @class */ (function () {
    ...
    CategoriaController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var categorias, serializedItems;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connection_1.default('categorias').select('*')];
                    case 1:
                        categorias = _a.sent();
                        serializedItems = categorias.map(function (item) {
                            return {
                                id: item.id,
                                title: item.title,
