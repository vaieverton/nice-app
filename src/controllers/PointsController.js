...
var PointsController = /** @class */ (function () {
    ...
    PointsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connection_1.default('points')
    ...
    PointsController.prototype.create = function (request, response) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var _b, name, email, whatsapp, latitude, longitude, items, description, endereco, trx, point, insertedIds, point_id, pointItems;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        console.log('chegou');
                        _b = request.body, name = _b.name, email = _b.email, whatsapp = _b.whatsapp, latitude = _b.latitude, longitude = _b.longitude, items = _b.items, description = _b.description, endereco = _b.endereco;
                    ...
                    case 2:
                        ...
                        pointItems = items
                            ...
                            .map(function (categoria_id) {
                            return {
                                categoria_id: categoria_id,
                                point_id: point_id,
                            };
                        });
                        return [4 /*yield*/, trx('point_categoria').insert(pointItems)];
                    case 3:
                        _c.sent();
